...
def predict():
    ...
    if prediction == 0:
        return render_template ('index.html',prediction_text='EMPLOYÉ NE RISQUE PAS DE PARTIR')

    else:
        return render_template ('index.html',prediction_text='EMPLOYÉ RISQUE DE PARTIR')
